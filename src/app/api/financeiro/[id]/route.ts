...
async function requireSuperAdmin(supabase: any, user: any) {
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (!await requireSuperAdmin(supabase, user)) return NextResponse.json({ error: 'Acesso negado' }, { status: 403 })
