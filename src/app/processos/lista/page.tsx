    ...
    <div className="space-y-5">
      ...
      <section className="eleva-surface p-4">
        <form className="grid gap-3 sm:grid-cols-2 lg:grid-cols-12" method="get">
          ...
          <select name="pendencia" defaultValue={params.pendencia} className="dash rounded-xl border border-input bg-card px-3 py-2.5 text-sm"><option value="">Todas as pendências</option><option value="etapa_vencida">Etapa vencida</option><option value="documento_analise">Documento</option><option value="sem_responsavel">Sem responsável</option><option value="autenticacao_cliente">Autenticação</option><option value="processo_parado">Parado</option></select>
